...
import 'package:watchman/model/subscription_model.dart';
...
class UserModel {
  ...
  UserModel(
      ...
      this.role,
      this.salary,
      this.password,this.adminCommission, this.subscriptions});
  ...
  Map<String, dynamic> toJson() {
    ...
    data['isSubscriptionEnable'] = isSubscriptionEnable;
    data['role'] = role;
