...
import 'package:watchman/ui/chat/chat_screen.dart';
...
class NotificationService {
  ...
  Future<void> setupInteractedMessage() async {
      ...
      if (message.notification != null) {
        ...
        if (message.data['type'] == "chat") {
          await FireStoreUtils.getUserProfile(
              ...
              .then((value) async {
            await FireStoreUtils.getOwnerProfile(value?.ownerId ?? '')
                .then((value) async {
    ...
    await FirebaseMessaging.instance.subscribeToTopic("watchMan");
  }
  ...
  void display(RemoteMessage message) async {
    ...
    try {
      AndroidNotificationChannel channel = const AndroidNotificationChannel(
        'mekinaparkingwatchman',
        'mekinaparkingwatchman',
        description: 'Show Mekina Watchman Notification',
